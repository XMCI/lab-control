...
class pdxc:
    ...
    def __init__(self): #the constructor will load the dll and create an pdxcobj
    ...
    def GetCalibrationIsCompleted(self, secondary, homed):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            homed: device calibration completed status #设备校准状态检验
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
        if self.hdl >= 0:
            ho = c_byte(0)
            ret = pdxc.pdxcLib.Get_CalibrationIsCompleted(self.hdl, secondary, byref(ho))
            homed[0] = ho.value
        return ret
    ...
    def GetCurrentPosition(self, secondary, position):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            position: current position: PDX1[-10,10]mm; PDX2[-2.5,2.5]mm; PDXZ1[-2.25,2.25]mm; PDXR:[-999.9,999.9] °
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def GetTargetTriggerPosition(self, secondary, position):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            position: target position: PDX1[-10,10]; PDX2[-2.5,2.5]mm; PDXZ1[-2.25,2.25]mm; PDXR:[-999.9,999.9]
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def GetSpeedStageType(self, secondary, type):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            type: stage type(0 :PDX1/PDX2/PDXR/PDXZ1 stage, 1 :SMC stage,2 :PD2/PD3 stage)
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def GetAllParametersInExternalTrigger(self, secondary, alltriggerState):
        ...
        rising / falling edge and value defined in PDX1/PDX2/PDXZ1(mm)/PDXR(°) unit, and Two - Position - Switching
        mode with rising / falling for each position, assigned by pos1 and pos2.
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
    ...
    def GetAnalogInputGain(self, secondary, aiGain):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            aiGain: analog input gain,the range is: PDX1/PDX2/PDXZ1:[0.1,1], PDXR1:[0.1,100]
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def GetAnalogInputOffSet(self, secondary, aiOffSet):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            aiOffSet: analog input offset:PDX1:[-10,10]mm; PDX2:[-2.5, 2.5]mm; PDXZ1[-2.25,2.25]mm; PDXR:[-999.9,999.9]°
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def GetAnalogOutOffSet(self, secondary, aoOffSet):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            aoOffSet: analog output offset:PDX1/PDX2:[-10,10]mm; PDXZ1[-2.25,2.25]mm; PDXR:[-999.9,999.9]°
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def SetTargetSpeed(self, secondary, speed):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            speed: desired speed(PDX1:2-20 mm/s; PDX2:1-10 mm/s; PDXZ1:1 mm/s; PDXR:10-30 °/s)
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def SetTargetPosition(self, secondary, position):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            position: Target Position: PDX1[-10,10]mm; PDX2[-2.5,2.5]mm; PDXZ1[-2.25,2.25]mm; PDXR:[-180,180]°
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def SetAnalogInputGain(self, secondary, aiGain):
        """ Change gain value of analog input, default input voltage range is[-10V, 10V],
        standing for PDX1[+ -10mm]/PDX2[+ -2.5]/PDXZ1[+-2.25mm]/PDXR[+ - 10°] position range.If change value of Gain&Offset,
        we will get new input voltage range.The analog input gain vaule(ING), calculated by(max - min) / 20,
        analog input offSet value(INO) calculated by(min + max) / 2. E.g.If new wanted input range is in[0V, 5V],
        which means analog input gain is 0.25, analog input offSet value is 2.5. (the new Voltage Sampled is function
        of Vold, ING and INO Vnew = ING * Vold + 1.5(1 - ING) - 0.15*INO, where Vout is default range's output.)
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            aiGain: gain value of analog input,the range is: PDX1/PDX2/PDXZ1:[0.1,1], PDXR1:[0.1,100]
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def SetAnalogInputOffSet(self, secondary, aiOffset):
        ...
        Gain&Offset, we will get new input voltage range.
        The analog input gain vaule(ING), calculated by(max - min) / 20, analog input offSet value(INO) calculated
         by(min + max)/ 2. E.g. If new wanted input range is in[0V, 5V], which means analog input gain is 0.25,
         analog input offSet value is 2.5.(the new Voltage Sampled is function of Vold, ING and INO
         Vnew = ING * Vold + 1.5(1 - ING) - 0.15*INO, where Vout is default range's output.)
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            aiOffset: offset value of analog input: PDX1:[-10,10]mm; PDX2:[-2.5, 2.5]mm; PDXZ1:[-2.25,2.25]mm;
            PDXR:[-999.9,999.9]°
        Returns:
            0: Success; negative number: failed.
        """
    ...
    def SetAnalogOutOffSet(self, secondary, aoOffset):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            aoOffset: offset Value of analog output:PDX1/PDX2:[-10,10]mm; PDXZ1[-2.25,2.25]mm; PDXR:[-999.9,999.9]°
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def SetPositionLimit(self, secondary, minvalue, maxvalue):
        ...
        Args:
            secondary: index in daisy chain (0:Single Mode or Main, 1 -11 : Secondary1 - Secondary11)
            minvalue: Minimum value of position, PDX1 range[-10,max] mm; PDX2 range[-2.5,max] mm; PDXZ1 range[-2.25,max] mm;
            PDXR range[-999.9,max] °
            maxvalue: Maximum value of position, PDX1 range[min,10] mm; PDX2 range[min,2.5] mm; PDXZ1 range[min,2.25] mm;
            PDXR range[min.9,999.9] °
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
    ...
    def SetStepPulseAndResponse(self, secondary, value):
        ...
        Args:
            ...
            value: relative distance to be moved:
                   PDX1:[-10,-0.00001]mm,[0.00001,10]mm;
                   PDXZ1:[-2.25,-0.0001],[0.0001,2.25]mm;
                   PDXR:[-180,-0.00005]°,[0.00005,180]°;
                   PDX2: [-2.5, -0.0003]mm, [0.0003, 2.5]mm
        Returns:
            0: Success; negative number: failed.
        """
        ret = -1
